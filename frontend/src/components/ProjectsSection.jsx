  ...
  const projectImages = [
    {
      ...
      imageSrc: "/images/kitchen.jpeg",
    },
    { id: 2, title: "Mind and Soul Website", imageSrc: "/images/yoga.jpeg" },
    { id: 3, title: "Customer Care Website", imageSrc: "/images/workers.jpeg" },
    { id: 4, title: "Cake business Website", imageSrc: "/images/cake.jpeg" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 mb-16 relative z-10">
        <h2
          ref={titleRef}
          className="text-4xl md:text-5x lg:text-6xl font-bold text-black text-center mb-4 opacity-0"
        >
          Featured Projects
        </h2>
        <div
