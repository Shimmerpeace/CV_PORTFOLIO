    ...
    >
      ...
      >
        <h3 className="text-sm md:text-2xl font-bold text-purple-200 z-50 lg:max-w-[45rem] max-w-[27rem] tracking-wider md:mt-20 sm:mt-[-40rem] mt-[-32rem]">
          Motivated and detail-oriented Front-End Developer skilled in building
          modern, responsive web applications. Proficient in React.js, Next.js,
          JavaScript, Node.js, HTML, and Tailwind CSS, with hands-on experience
          integrating APIs and implementing best practices in responsive design.
        </h3>
        <img
